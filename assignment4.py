...
# Q5: 2D array of 3x4
ucs420_hunar = np.array([[10, 20, 30, 40],
                                 [50, 60, 70, 80],
                                 [90, 15, 20, 35]])
print("Original 2D Array:\n", ucs420_hunar)
print("Mean:", np.mean(ucs420_hunar))
print("Median:", np.median(ucs420_hunar))
print("Max:", np.max(ucs420_hunar))
print("Min:", np.min(ucs420_hunar))
print("Unique elements:", np.unique(ucs420_hunar))

# Reshape to 4x3
reshaped_ucs420 = ucs420_hunar.reshape(4, 3)
print("Reshaped to 4x3:\n", reshaped_ucs420)

# Resize to 2x3
resized_ucs420 = np.resize(ucs420_hunar, (2, 3))
